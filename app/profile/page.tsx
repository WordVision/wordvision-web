      ...
      <div className="px-4 flex-1">
        <div className="p-4 flex flex-col items-center gap-4 border-b">
          <div
            ...
            className="mt-4 w-[72px] h-[72px] text-2xl flex justify-center items-center rounded-full shadow-[inset_0px_-8px_16px_0px_rgba(0,0,0,0.1)]"
          >
            {userData.firstName[0] + userData.lastName[0]}
          </div>
          <p style={inter500.style} className=" text-lg">
            {userData.firstName} {userData.lastName}
          </p>
        </div>

        <div className="py-4 px-2 border-b">
          <p style={inter400.style} className="px-2 text-xs">Email</p>
          <input
            type="text"
        ...
        <div className="py-4 px-2 border-b">
          <p style={inter400.style} className="px-2 text-xs">Password</p>
          <input
            type="password"
        ...
        <div className="py-4 px-2 border-b">
          <p style={inter400.style} className="px-2 text-xs">Date of Birth</p>
          <p style={inter500.style} className="px-2 text-sm">
